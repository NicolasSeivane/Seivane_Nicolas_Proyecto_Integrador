...
\noindent
Dentro de este trabajo no sólo se evaluarán distintos modelos, sino que se utilizarán distintos \emph{datasets} para lograrlos. A continuación se señalaran las métricas que se utilizarán en cada caso y se podrán apreciar algunas diferencias, leves, pero diferencias en sí. 
...
\noindent
La función logística define la \textbf{función de Probabilidad} de pertenencia de $x_{i}$ a la clase $1$ como:
...
\noindent
Se buscó evaluar el rendimiento de cada modelo bajo diferentes configuraciones de hiperparámetros, a través de métricas como la precisión (\textit{Accuracy}), el F1-Score y el área bajo la curva ROC (ROC AUC), entre otras.\\

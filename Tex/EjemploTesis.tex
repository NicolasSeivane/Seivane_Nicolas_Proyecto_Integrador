...
\noindent
En términos de la Matriz de Confusión la formula sería la siguiente:
\begin{equation}
...
\noindent
Se buscan evaluar el rendimiento de cada modelo bajo diferentes configuraciones de hiperparámetros, a través de métricas como la precisión (\textit{Accuracy}), el F1-Score y el área bajo la curva ROC (ROC AUC), entre otras.\\
...
\noindent
La \textbf{Regresión Logística} obtuvo un buen desempeño en la clasificación binaria, siempre tomando un \textbf{buen resultado} cuando cualquier métrica por lo menos supere los 0.80.\\
...
La \textbf{Máquinas de Soporte Vectorial (SVM)} obtuvo un desempeño sólido en la clasificación binaria, mostrando un equilibrio adecuado entre precisión y generalización.\\
